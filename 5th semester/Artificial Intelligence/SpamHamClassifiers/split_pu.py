...
train_types =[]
for i in range(8):
    x,y = find_paths_pu("pu_corpora_public\\pu1\\part"+str(i+1))
    for i,j in zip(x,y):
        train_path.append(i)
        train_types.append(j)
dev_paths,dev_types = find_paths_pu("pu_corpora_public\\pu1\\part9")
test_paths,test_types = find_paths_pu("pu_corpora_public\\pu1\\part10")
